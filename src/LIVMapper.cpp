...
void LIVMapper::imu_cbk(const sensor_msgs::Imu::ConstPtr &msg_in)
{
  ...
  msg->header.stamp = ros::Time().fromSec(msg->header.stamp.toSec() - imu_time_offset + (last_timestamp_lidar - msg->header.stamp.toSec() - imu_time_offset));
